...
public class SubscriptionResource {
  ...
  private Page<SubscriptionResponse> getSubscriptionsPage(
      Page<Subscription> allSubscriptions, Pageable pageable) {
    return new PageImpl<>(
        getSubscriptionResponseList(allSubscriptions), pageable, allSubscriptions.getSize());
  }

  private List<SubscriptionResponse> getSubscriptionResponseList(
      Page<Subscription> allSubscriptions) {
