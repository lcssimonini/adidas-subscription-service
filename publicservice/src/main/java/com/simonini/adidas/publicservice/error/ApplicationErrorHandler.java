...
import com.simonini.adidas.publicservice.error.exceptions.NotFoundException;
...
//    }
    ...
    private String getFormattedMessage(FieldError fieldError) {
        return String.format(FIELD_ERROR_MESSAGE_TEMPLATE, fieldError.getField(), fieldError.getDefaultMessage());
    }
}
